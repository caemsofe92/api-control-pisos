...
router.post("/", async (req, res) => {
  try {
    ...
    let _Ingress = await axios
        ...
        .patch(
          `${tenant}/data/NAVTruckEntrances(dataAreaId='${Ingress.dataAreaId}',NAVEntranceId='${Ingress.NAVEntranceId}')?cross-company=true`,
          Ingress,
          {
    ...
    _Ingress =
      ...
      let _IngressCaseTable = await axios
    ...
    _IngressCaseTable =
    _IngressCaseTable && _IngressCaseTable.data === "" ? "Modified" : "Unchanged";
